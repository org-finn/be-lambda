    ...
    for record in event.get('Records', []):
        try:
            ...
            row = {
                ...
                "positive_keywords": (body.get('positiveKeywords'))[:100] if body.get('positiveKeywords') else None,
                "negative_keywords": (body.get('negativeKeywords'))[:100] if body.get('negativeKeywords') else None,
